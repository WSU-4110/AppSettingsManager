...
namespace AppSettingsManagerApi.Infrastructure.Migrations
{
    public partial class Permissions : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropIndex(name: "IX_Settings_BaseUserUserId", table: "Settings");

            migrationBuilder.DropColumn(name: "BaseUserUserId", table: "Settings");

            migrationBuilder.RenameColumn(name: "Id", table: "Settings", newName: "SettingGroupId");
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    constraints: table =>
                    {
                        table.PrimaryKey("PK_SettingGroups", x => x.SettingGroupId);
                    }
                )
                .Annotation("MySql:CharSet", "utf8mb4");
                ...
                .CreateTable(
                    ...
                    columns: table =>
                        new
                        {
                            ...
                            SettingGroupId = table
                                .Column<string>(type: "varchar(255)", nullable: false)
                                .Annotation("MySql:CharSet", "utf8mb4"),
                            CurrentPermissionLevel = table.Column<int>(
                                type: "int",
                                nullable: false
                            ),
                            ApprovedBy = table
                                .Column<string>(type: "longtext", nullable: false)
                                .Annotation("MySql:CharSet", "utf8mb4"),
                            WaitingForApproval = table.Column<bool>(
                                type: "tinyint(1)",
                                nullable: false
                            ),
                            RequestedPermissionLevel = table.Column<int>(
                                type: "int",
                                nullable: false
                            )
                        },
                    constraints: table =>
                    {
                        ...
                        table.ForeignKey(
                            ...
                            principalColumn: "SettingGroupId",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "SettingGroups");

            migrationBuilder.DropTable(name: "Users");

            migrationBuilder.RenameColumn(name: "SettingGroupId", table: "Settings", newName: "Id");
